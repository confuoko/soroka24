...
Сейчас резолвер отдаёт этому клиенту шесть доменов — Московскую область (*.mo.msudrf.ru,
374 суда), Алтайский край (*.alt.msudrf.ru, 143 суда), Амурскую область (*.amr.msudrf.ru,
49 судов), Архангельскую область вместе с Ненецким АО (*.arh.msudrf.ru, 72 суда),
Астраханскую (*.ast.msudrf.ru, 53 суда) и Белгородскую (*.blg.msudrf.ru, 80 судов)
области, итого 771 из 6064 (см. константы доменов ниже). Сам движок общий для 6064 судов
из 71 региона (78% мировых судов страны): разметка, капча и адреса карточек у них
...
# на этих шести, и обещать остальные 5293 суда, ни разу их не открыв, нечестно. Чтобы
