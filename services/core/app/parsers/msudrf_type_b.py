"""Парсер карточки дела мировых судов Московской области (*.mo.msudrf.ru) — страница типа B.
...
Чего на этих страницах нет вовсе: истории местонахождения, таблицы судебных заседаний,
        ...
        events.append(
            {
                ...
                # Документов-оснований на страницах МО нет — колонки под них не бывает.
                "document_str": None,
...
class MsudrfTypeBParser(CaseParser):
    """Парсер страниц типа B (мировые суды Московской области, msudrf.ru)."""
