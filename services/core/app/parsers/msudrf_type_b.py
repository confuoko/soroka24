...
Разметка у движка общая на все регионы; проверена на Московской области (*.mo.msudrf.ru),
Алтайском крае (*.alt.msudrf.ru), Амурской (*.amr.msudrf.ru), Архангельской
(*.arh.msudrf.ru) и Астраханской (*.ast.msudrf.ru) областях, примеры —
в html_examples/mo_case_*.
