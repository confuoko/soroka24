...
from app.models.database import Case, PlaceHistory
...
class PlaceHistoryRepository:
    ...
    def sync_place_history(
        self, case: Case, places_data: list[dict]
        ...
        for item in places_data:
            ...
            elif existing_place.comment != item.get("comment"):
                existing_place.comment = item.get("comment")
